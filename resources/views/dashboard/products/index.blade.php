...
<a href="{{ route('dashboard.products.create') }}" class="btn btn-sm btn-outline-info mb-4"> Create </a>
{{-- <a href="{{ route('dashboard.products.trash') }}" class="btn btn-sm btn-outline-info mb-4"> Trash </a> --}}
<table class="table">
    <thead>
        <tr>
            <th></th>
    ...
    <tbody>
        ...
        @empty
        <td colspan="9">nothig to</td>
        @endforelse
    </tbody>
</table>
{{ $products->withQueryString()->appends(['search' => 2])->links() }}
@endsection
