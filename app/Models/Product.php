...
class Product extends Model
{
    ...
    function scopeActive(Builder $builder) {
     ...
     // Accessors : get...Attribute, write it in camel case and call
    //  it in ... I forgot the name but look to the function to know
    // $product->image_url
    ...
    public function getSalePriceAttribute()
    {
        if( $this->compare_price)
            return 100 - ($this->price / $this->compare_price * 100) .'%' ;
        return null;
    }
    // this is by tutor
